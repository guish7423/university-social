...
blockHandler := handler.NewBlockHandler(blockRepo)
	...
	})
	{
		...
		auth.Use(middleware.AuthRequired(cfg))
		{
			...
			auth.PUT("/user/password", authHandler.ChangePassword)
		...
		auth.GET("/circles/:id/activities", circleHandler.ListActivities)
			auth.POST("/circles/:id/posts/:postId/pin", circleHandler.PinPost)
			auth.POST("/circles/:id/posts/:postId/unpin", circleHandler.UnpinPost)
